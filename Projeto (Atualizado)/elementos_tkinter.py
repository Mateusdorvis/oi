...
class CriarBotao(tk.Button):
      def __init__(self,master, **kwargs):
        super().__init__(master, **kwargs)
        self.config_grid_button
    
      def config_grid_button(self,linha_grid, coluna_grid, **args):
...
class LabelPronta(tk.Label):
    ...
    def configgrid_label(self,linha_label, coluna_label, **args):
...
class EntradaTexto(tk.Text):
    ...
    def configgrid_text(self,linha_text, coluna_text, **args):
        self.grid(row=linha_text, column=coluna_text, **args)

class Entrada(tk.Entry):
    def __init__(self,master, **kwargs):
        super().__init__(master, **kwargs)
        self.configgrid_entry

    def configgrid_entry(self,linha_entry, coluna_entry, **args):
